<template>
    <div class="content-wrapper">
        ...
        <bs-modal
            ...
            max-width="85%"
        >
            <b>¿Desea eliminar el perfil?</b><br />
            Al eliminar el perfil, no podrá usarlo en las transacciones. <br />
        ...
        eliminar() {
            ...
            axios
                ...
                .then(function() {
                    ...
                    that.$refs.gridPerfil.reload();
                    that.showNotificationProgress(
                        "Exito al procesar",
                        "Usted ha eliminado correctamente el perfil." +
