   ...
   <bs-alert color="success">
    ...
    <bs-card shadow>
      ...
      <bs-grid :data-source="inventario_p"
               :pageable="pagination"
               row-hover>
        <bs-grid-column field="producto_inv.nombre"
                        label="Producto"
                        min-width="175"></bs-grid-column>
        <bs-grid-column field="costo_inv.precio"
                        label="Valor"
     ...
     placeholder="Placeholder" floating-label outlined
     @keydown="calcular()"
     v-model="cantidad"
     >
               ...
               // sorts: [{ property: "nombre", direction: "asc" }],
                restProxy: {
                   // browse:"/modulos/administracion/facturacion/productos_invo/",
                    fetch:'/modulos/transaccion/factura_venta/productos_invo/{id}',
                }
            }),
            item:{},
        };
