...
export default {
    data: function() {
        return {
            ...
            inventario_p: new BsStore({
                ...
                //sorts: [{ property: "producto_inv.nombre", direction: "asc" }],
                restProxy: {
    ...
    methods: {
        onSearch(term) {
            ...
            console.log(this.inventario_p); */
            this.inventario_p.fetch(term, 'holi')
            .then(function(response) {
                console.log(response.data.producto_inventario)
